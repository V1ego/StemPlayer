...
;self.SoundTouch=SoundTouch;self.FifoSampleBuffer=FifoSampleBuffer;self.RateTransposer=RateTransposer;self.Stretch=Stretch;self.SimpleFilter=SimpleFilter;self.PitchShifter=PitchShifter;self.WebAudioBufferSource=WebAudioBufferSource;